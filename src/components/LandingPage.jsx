...
function LandingPage() {
  return (
    ...
    <div data-scroll data-scroll-section data-scroll-speed="-.3" className="w-full h-screen bg-zinc-100 pt-1 ">
          ...
          return (
            <div className="masker ">
              <div className="w-fit flex ">
                ...
                <h1 className='text-[7vw] uppercase leading-[6vw] tracking-tighter font-["Founders_Grotesk"] font-semibold text-zinc-900'>
                  {item}
                </h1>
              </div>
            </div>
      ...
      <div className="border-t-[1px] border-zinc-300 mt-24 flex justify-between items-center py-4 px-8">
        {[
        ...
        <div className="start flex items-center gap-2">
          <p className="uppercase text-sm font-normal border-[2px] border-zinc-600 rounded-full py-2 px-3 text-zinc-900">
            Start the project
          </p>
