...
function Footer() {
  return (
    <div data-scroll data-scroll-section data-scroll-speed="-.03" className='w-full h-screen bg-zinc-100 rounded-t-3xl text-zinc-900 md:px-16 px-6 py-24 flex md:flex-row flex-col relative'>
        <div className="w-1/2 flex flex-col justify-between">
            <div className="heading font-Founders_semibold flex flex-col ">
                <h1 className='md:text-[7vw] text-[12vw] uppercase md:leading-[6vw] leading-[10vw] tracking-tighter'>Eye-</h1>
                <h1 className='md:text-[7vw] text-[12vw] uppercase md:leading-[6vw] leading-[10vw] tracking-tighter'>Opening</h1>
            </div>
            <svg className='absolute left-6 bottom-16 md:left-16' width="72" height="30" viewBox="0 0 72 30" fill="none" xmlns="http://www.w3.org/2000/svg">
        ...
        <div className="w-1/2">
            <div className="heading mb-9 mt-0 font-Founders_semibold ">
            <h1 className='md:text-[7vw] text-[12vw] font-semibold uppercase md:leading-[6vw] leading-[10vw] tracking-tighter'>presentations</h1>
            </div>
            <h1 className='md:text-xl text-sm px-2 mb-3 text-zinc-700 font-Neue_Montreal'>S:</h1>
            <div className="content flex flex-col md:text-base text-sm text-zinc-600 capitalize underline underline-offset-4 px-2 font-Neue_Montreal">
                {["Instagram", "Facebook", "LinkedIn","Behance"].map((item,index)=>(
                    <a href="#" >{item}</a>
                ))}
            </div>
            <h1 className='md:text-xl text-sm px-2 mb-3 text-zinc-700 mt-12 font-Neue_Montreal'>M:</h1>
            <div className="content flex flex-col md:text-base text-sm text-zinc-600  capitalize underline underline-offset-4 px-2 font-Neue_Montreal ">
