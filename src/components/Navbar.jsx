...
function Navbar() {
  ...
  return (  
    ...
    <div className='fullSNavbar fixed z-50 w-full md:px-12 px-6 py-6 flex items-center justify-between backdrop-blur-sm '>
        ...
        <div className="links md:flex md:flex-row md:py-0 md:border-none md:my-0 md:font-Neue_Montreal md:gap-[2vw] hidden">            
           {["Services", "Our Work", "About Us", "Insights", "Contact Us"].map((item,index)=>(
                <a key={index} className={ `ml-[1vw] text-base ${ index === 4 && "pl-[10vw]" } text-zinc-900`}>{item}</a>
           ))}
        </div>
        <div className="menuicon md:hidden text-zinc-900 h-[2vw] w-[2vw] flex justify-center items-center cursor-pointer">
            <span className= 'scale-150' onClick={toggleMenu}>
            <HiOutlineMenuAlt4 /> 
            </span>
        </div>
        ...
        {isOpen && (
          <div className="w-full h-screen bg-zinc-800 absolute top-0 left-[50%] -translate-x-[50%] ">
            <div className="navSection flex justify-between items-center border-b-[1px] border-zinc-600 pt-6 pb-12 px-6">
              <div className="logo text-zinc-100 ">
                  <svg width="72" height="30" viewBox="0 0 72 30" fill="" xmlns="http://www.w3.org/2000/svg">
									<path d="M9.8393 10.2032C4.22951 10.3257 -0.0459221 14.7356 0.000372391 20.2752C0.0412204 25.3548 4.57808 30.3608 10.6862 29.9226C15.5145 29.5768 19.9015 25.4119 19.8525 20.0057C19.8035 14.5995 15.1904 10.0916 9.8393 10.2032ZM9.89649 25.7005C6.87101 25.7005 4.39834 23.1144 4.40924 19.9839C4.39525 19.2507 4.52792 18.522 4.79947 17.8407C5.07102 17.1594 5.47597 16.5392 5.99056 16.0164C6.50515 15.4937 7.11902 15.0789 7.79613 14.7966C8.47324 14.5142 9.19995 14.3698 9.93362 14.372C10.6673 14.3742 11.3931 14.5228 12.0686 14.8092C12.744 15.0956 13.3554 15.514 13.8668 16.0398C14.3783 16.5656 14.7796 17.1882 15.0471 17.8711C15.3146 18.554 15.4429 19.2834 15.4246 20.0166C15.4409 23.1008 12.9111 25.7059 9.88832 25.7005H9.89649Z" fill="currentColor"></path>
									<path d="M62.8086 29.4855H67.1222V10.6372H62.8086V29.4855Z" fill="currentColor"></path>
									<path d="M67.6816 0.172852V6.13439H71.5322C71.6738 6.13439 71.8046 6.13439 72.0006 6.11534V0.172852H67.6816Z" fill="currentColor"></path>
                  ...
                  <div className="cross h-[2vw] w-[2vw] cursor-pointer flex justify-center items-center">
                    <span className='scale-150' onClick={toggleMenu}>
                      <RxCross2 />
                    </span>
                  </div>
              </div>
              <div className="links font-Founders_semibold tracking-tighter leading-[16vw] py-6 px-6 ">
              {["Services", "Our Work", "About Us", "Insights", "Contact Us"].map((item,index)=>(
               <a key={index} className={`text-[12vw] text-zinc-100 block`}>{item}</a>
          ))}
              </div>
          </div>
